            ...
            <Col className="py-2 mx-auto text-center" md={6}>
                <Container>
                    <Form onSubmit={handleSubmit}>
                        <Form.Group>
                            <Form.Label className={`${styles.PageFont} ${styles.BlueFont}`}>New password</Form.Label>
                            <Form.Control
                        ...
                        <Form.Group>
                            <Form.Label className={`${styles.PageFont} ${styles.BlueFont}`}>Confirm password</Form.Label>
                            <Form.Control
